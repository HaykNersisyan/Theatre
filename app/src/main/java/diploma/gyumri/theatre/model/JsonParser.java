...
//            JSONObject obj = new JSONObject(loadJSONFromAsset(activity));
            JSONObject obj = new JSONObject("{\n" +
                    ...
                    "      \"desc\": \" Բեմադրությունը և երաժշտական ձևավորումը` Ռաֆայել Ասատրյանի\n" +
                    "Նկարչական ձևավորումը և զգեստները`\n" +
                    "Լուսինե Խաչատրյանի\n" +
                    "Գլխավոր դերերում` Դիանա Մացոյան,\n" +
                    "ՀՀ վաստակավոր արտիստ Տիգրան Գաբոյան \",\n" +
                    "      \"price\": \" 1000-2500\",\n" +
                    "      \"stage\": \" Small hall \",\n" +
